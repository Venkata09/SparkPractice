...
import data_analysis_on_sample_data.scalaeg.SelectTopNExample.A
...
object ExplodeRDD {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val timeValueDS =  spark.sparkContext.parallelize(Seq(TimeValue(1, 3), TimeValue(2, 7), TimeValue(3, 10),
      TimeValue(4, 13))).toDF("value", "time")
